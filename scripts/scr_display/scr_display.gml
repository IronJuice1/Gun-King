...
function draw_text_shadow(_x, _y, _txt, _shadow_dist, _col) {
	
	draw_text_color(_x + _shadow_dist, _y + _shadow_dist, _txt, c_black, c_black, c_black, c_black, 1)
	draw_text_color(_x, _y, _txt, _col, _col, _col, _col, 1)
